...
//        ta.setEnabled(false);
    ...
    public void CGPA(){
        ...
        int  Ci = 0,Pj=0;
            ...
            Cnum2 = mo.getValueAt(0, 2).toString();
            Pnum2 = mo.getValueAt(0, 3).toString();
            Cnum = Integer.parseInt(Cnum2);
            Pnum = Integer.parseInt(Pnum2);
//            
            while (Cn > Ci) {
                ...
                Pnum2 = mo.getValueAt(Pj, 3).toString();
                Pnum = Integer.parseInt(Pnum2);
