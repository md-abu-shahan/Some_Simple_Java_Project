...
public class StudentInformations extends JFrame implements ActionListener {
    
    private Container c;
    private JLabel l1, l2, l3, l4, head;
    private Font f1, f2;
    private JTextField ft, lt, pt, gt;
    private JButton ab, ub, db, cb;
    private JTable ta;
    private DefaultTableModel mo;
    private JScrollPane sp;
    
    private String[] col = {"First name", "Last name", "Phone", "GPA"};    
...
//        ta.setEnabled(false);
    ...
    public static void main(String[] args) {
        ...
        StudentInformations f = new StudentInformations();
        f.setVisible(true);
